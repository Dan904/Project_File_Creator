...
inputs: date, client, client's client, project name, pl number, Client short code

outputs: folder structure, log, 

Projects/
    Client/
        Client's Client/
            170407_CSC_Project_Name/
                00_Finals/
                    PL#
                    00_Cuts/
                01_Documents
                ...
                04_Project_Files/
                    Backup Projects/
                    DATE_CSC_PROJECT.aep
                    DATE_CSC_PROJECT.prproj
